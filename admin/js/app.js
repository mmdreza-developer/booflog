  ...
  $(".bookmark-wrapper .bookmark-star").on("click", function (e) {
    ...
    for (var i = 0; i < arrList.length; i++) {
      ...
      $arrList +=
        ...
        "</span>" +
        "</div>" +
        '<span class="float-right bookmark-icon fa-regular fa-star "></span>' +
        "</a>" +
        "</li>"
    }
        ...
        $.getJSON("../../../app-assets/data/" + $filename + ".json", function (
          ...
          for (var i = 0; i < data.listItems.length; i++) {
            ...
            if (bookmark === true) {
              ...
              $bookmarkIcon =
                '<span class="float-right bookmark-icon fa-regular fa-star' +
                activeClass +
                '"></span>'
            }
          ...
          if ($startList == "" && $otherList == "") {
            $otherList =
              ...
              '<div class="d-flex justify-content-start">' +
              '<span class="mr-75 fa-solid fa-circle-exclamation"></span>' +
        ...
        if (bookmark === true) {
          ...
          for (var i = 0; i < arrList.length; i++) {
            ...
            $arrList +=
              ...
              "</span>" +
              "</div>" +
              '<span class="float-right fa-regular fa-star"></span>' +
              "</a>" +
              "</li>"
          }
          $("ul.search-list").append($arrList)
